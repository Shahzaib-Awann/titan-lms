...
import { getAssignedBatches } from "@/lib/actions/batch.action";
...
type BatchesPageContentProps = {
  role: Exclude<Role, "admin">;
  search?: string;
  sort?: "asc" | "desc";
};

const BatchesPageContent = async ({
  role,
  search,
  sort,
}: BatchesPageContentProps) => {
  ...
  const basePath = isTrainer ? "/trainer/batches" : "/student/my-courses";
            ...
            return (
              ...
              >
                <CardContent className="grid gap-6 py-4 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      <div className="mt-6 space-y-3">
                        ...
                        {isTrainer && (
                          <Meta
                            icon={Users}
                            text={`${batch.studentCount ?? 0} Students`}
                          />
                        )}
                      </div>
                    </div>
                  ...
                  {/* RIGHT SIDE */}
                  <div className="flex flex-col justify-between space-y-6 border-l pl-6">
                    {/* PROGRESS */}
...
export default BatchesPageContent;
